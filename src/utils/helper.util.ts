import { AppChannel } from "./enums.util";
...
export const detectPlatform = (
  ...
  switch (normalized) {
    case "tablet":
      return AppChannel.TABLET;
    case "mobile":
    case "phone":
      return AppChannel.MOBILE;
    case "desktop":
      return AppChannel.DESKTOP;
    case "smart-tv":
    case "tv":
      return AppChannel.SMART_TV;
    case "watch":
      return AppChannel.WATCH;
    case "web":
      return AppChannel.WEB;
    default:
      return AppChannel.WEB;
  }
};
